const teamItems = [
  ...
  },
  {
    ...
    mainDuties:
      'Реализация разметки в handelbars основного модального окна для выбранного фильма. Написание функционала по смене внешнего вида хедера на разных страницах ("домашняя" и "моя библиотека") на JS. Отрисовка макета модального окна с участниками команды в футере. Организация ежедневных stand-upов с фиксацией статусов по каждому направлению. Распределение равномерной нагрузки на каждого участника проекта и контроль за соблюдением deadline',
      id: 2,
  },
  {
  ...
  },
  {
    ...
    telNumber: '+380666699988',
    mainDuties: 'Создание разметки при помощи handelbars и стилизация карточек популярных фильмов на главной странице, а также сохраненных на странице "моя библиотека". Реализация функционала смены темной и светлой темы на странице при помощи JS',
    id: 4,
  },
  {
